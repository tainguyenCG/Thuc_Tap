...
const MainNavbar = ({ bottomCropped = false }: TMainNavbar) => {
  ...
  return (
    <div className={`bg-[#2196f3]  text-white ${bottomCropped ? "items-center py-1" : "pt-2 pb-5"}`}>
            ...
            >
              <div className="flex rounded-sm bg-white p-1">
                <input
                  ...
                  {...register("search")}
                />
                <button className="rounded-sm bg-[#2196f3]  py-2 px-4 hover:opacity-90 lg:px-6">
                  <svg
                      ...
                      <>
                        ...
                        <div className="mt-5">
                          {purchasesInCart.slice(0, MAX_PURCHASES_PER_CART).map((purchase) => (
                            ...
                            >
                              ...
                              <div className="ml-2 flex-shrink-0">
                                <span className="text-blue-500">₫{formatCurrency(purchase.product.price)}</span>
                              </div>
                            </Link>
                          ))}
                          <div className="mx-2 mb-2 mt-6 flex items-center justify-between">
                            ...
                            <button
                              className="rounded-sm bg-blue-500 px-4 py-2 capitalize text-white hover:bg-opacity-90"
