        ...
        <div className="flex flex-wrap items-center gap-2">
          ...
          <button
            className={classNames("h-8 px-4 text-center text-sm capitalize ", {
              "bg-[#2e52b1] text-white hover:bg-[#2e52b1]/80": isActiveSortBy(sortBy.view),
          ...
          <button
            className={classNames("h-8 px-4 text-center text-sm capitalize ", {
              "bg-[#2e52b1] text-white hover:bg-[#2e52b1]/80": isActiveSortBy(sortBy.createdAt),
          ...
          <button
            className={classNames("h-8 px-4 text-center text-sm capitalize ", {
              "bg-[#2e52b1] text-white hover:bg-[#2e52b1]/80": isActiveSortBy(sortBy.sold),
          ...
          <select
            className={classNames("h-8 px-4 text-center text-sm capitalize ", {
              "bg-[#2e52b1] text-white hover:bg-[#2e52b1]/80": isActiveSortBy(sortBy.price),
