  ...
  return (
    <div className="py-4">
      <Link
        ...
        className={classNames("flex items-center font-bold  text-blue-500")}
      >
        <svg
          viewBox="0 0 12 10"
            ...
            >
              ...
              >
                {isActive && (
                  <svg
                    viewBox="0 0 4 7"
                    className="absolute top-1 left-[-10px] h-2 w-2 fill-blue-500"
                  >
      ...
      <Link
        to={path.home}
        className="mt-4 flex items-center font-bold uppercase text-blue-500"
      >
        <svg
      ...
      <div className="my-5">
        ...
        >
          ...
          {errors.price_min?.message ? (
            <div className="mt-1 min-h-[24px] text-center text-base text-blue-500">{errors.price_min?.message}</div>
          ) : (
            <div className="mt-1 min-h-[24px] text-center text-base text-blue-500"></div>
          )}
          <Button className="flex w-full items-center justify-center bg-blue-500 p-2 text-sm uppercase text-white hover:bg-blue-500/80">
            Áp dụng
          </Button>
        </form>
      </div>
      ...
      <Button
        ...
        className="flex w-full items-center justify-center bg-blue-500 p-2 text-sm uppercase text-white hover:bg-blue-500/80"
      >
        Xóa tất cả
      </Button>
    </div>
