...
const Register = () => {
  ...
  return (
    <div className="grid h-screen grid-cols-1 bg-[#2196f3] py-12 lg:grid-cols-3 lg:py-24 lg:pr-10">
      <Helmet>
        <title> Đăng ký</title>
        <meta
          name="description"
          content={`Trang đăng ký `}
        />
      </Helmet>
      <div className="bg-[#2196f3] lg:col-span-1 lg:col-start-2  ">
        <form
          onSubmit={handleSignUp}
          className="mt-14 rounded bg-white p-10 shadow-sm "
          noValidate
          autoComplete="on"
        >
