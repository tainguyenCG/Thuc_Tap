            ...
            <div className="mt-5 block lg:col-span-7">
              ...
              <div className="mt-8 flex items-center">
                <div className="flex items-center">
                  <span className="mr-1 border-b border-b-blue-500 text-blue-500">{product.rating}</span>
                  <ProductRating
              ...
              <div className="mt-8 flex items-center gap-x-4 bg-gray-50 px-5 py-4">
                ...
                <div className="text-2xl font-medium text-blue-500 sm:text-3xl">₫{formatCurrency(product.price)}</div>
                <div className="rounded-sm bg-blue-500 px-1 py-[2px] text-xs font-semibold uppercase text-white">
              ...
              <div className="mt-8 sm:flex sm:items-center sm:gap-x-4">
                <button
                  ...
                  className="flex h-12 w-full items-center justify-center rounded-sm border border-blue-500 bg-blue-500/10 px-5 capitalize text-blue-500 shadow-sm hover:bg-blue-500/5 sm:w-auto"
                >
                  <svg
                    ...
                    x={0}
                    y={0}
                    className="mr-[10px] h-5 w-5 fill-current stroke-blue-500 text-blue-500"
                  >
                    <g>
                      <g>
                        <polyline
                ...
                <button
                  ...
                  className="mt-5 flex h-12 w-full min-w-[5rem] items-center justify-center rounded-sm bg-blue-500 px-5 capitalize text-white shadow-sm outline-none hover:bg-blue-500/90 sm:mt-0 sm:w-auto"
                >
                  Mua ngay
                </button>
              </div>
